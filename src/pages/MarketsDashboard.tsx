...
export default function MarketsDashboard({ onSelectToken, onNavigateToTab }: MarketsDashboardProps) {
  ...
  const marketTokens = useMemo(() => {
    return [
      ...
      { id: '4', rank: 4, name: 'Shiba Inu', symbol: 'SHIB', price: 0.00002156, change24h: -3.20, volume24h: 640000000, marketCap: 12800000000, chain: 'ethereum' as const, address: '0x95ad61b0a150d79219dcf64e1e6cc01f0b64c4ce', sparkline: [0.0000225, 0.0000221, 0.0000219, 0.0000223, 0.0000217, 0.0000216, 0.00002156] },
      ...
      { id: '6', rank: 6, name: 'dogwifhat', symbol: 'WIF', price: 2.34, change24h: 15.30, volume24h: 342000000, marketCap: 2340000000, chain: 'solana' as const, address: 'EKpQGSJtjMFqKZ9KQanSqYXRcF8fBopzLHYxdM65zcjm', sparkline: [1.95, 2.05, 2.12, 2.08, 2.22, 2.28, 2.34] },
      { id: '7', rank: 7, name: 'Popcat', symbol: 'POPCAT', price: 1.45, change24h: 8.90, volume24h: 185000000, marketCap: 1450000000, chain: 'solana' as const, address: '7GCihgDB8fe6KNjn2MYtkzZcRjQy3t9GHdC8uHYmW2hr', sparkline: [1.31, 1.34, 1.39, 1.35, 1.41, 1.42, 1.45] },
      { id: '8', rank: 8, name: 'Dogecoin', symbol: 'DOGE', price: 0.1523, change24h: 4.60, volume24h: 924000000, marketCap: 22100000000, chain: 'bsc' as const, address: '0xba2ae424d960c26247dd6c32edc70b295c744c43', sparkline: [0.142, 0.145, 0.148, 0.146, 0.151, 0.150, 0.1523] },
      { id: '9', rank: 9, name: 'Floki', symbol: 'FLOKI', price: 0.0001834, change24h: 8.70, volume24h: 215000000, marketCap: 1750000000, chain: 'bsc' as const, address: '0xfb5b838b6cfeedc2873ab27866079ac55363d37e', sparkline: [0.000165, 0.000171, 0.000169, 0.000175, 0.000179, 0.000181, 0.0001834] },
      { id: '10', rank: 10, name: 'Brett', symbol: 'BRETT', price: 0.1245, change24h: 22.10, volume24h: 98000000, marketCap: 1245000000, chain: 'ethereum' as const, address: '0x532f27101965dd16442e59d40670faf5ebb142e4', sparkline: [0.098, 0.105, 0.110, 0.108, 0.118, 0.121, 0.1245] },
      { id: '11', rank: 11, name: 'Bonk', symbol: 'BONK', price: 0.00002789, change24h: -1.80, volume24h: 185000000, marketCap: 1950000000, chain: 'solana' as const, address: 'DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263', sparkline: [0.0000291, 0.0000285, 0.0000288, 0.0000282, 0.0000286, 0.0000280, 0.00002789] },
      { id: '12', rank: 12, name: 'Neiro', symbol: 'NEIRO', price: 0.00156, change24h: 31.50, volume24h: 320000000, marketCap: 654000000, chain: 'ethereum' as const, address: '0x812ba41e071c7b7fa4ebcfb62df5f45f6fa853ee', sparkline: [0.00115, 0.00122, 0.00129, 0.00125, 0.00141, 0.00148, 0.00156] }
    ];
  }, []);
